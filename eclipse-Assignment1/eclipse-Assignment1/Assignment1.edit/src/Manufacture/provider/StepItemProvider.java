...
public class StepItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Step_Produces_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Step_Produces_feature", "_UI_Step_type"),
				 ManufacturePackage.Literals.STEP__PRODUCES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPersonPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Step_person_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Step_person_feature", "_UI_Step_type"),
				 ManufacturePackage.Literals.STEP__PERSON,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Step_type") + " " + step.getSpeed();
	}
